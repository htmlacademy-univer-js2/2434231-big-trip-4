...
import { getDateDifference, getMonthAndDate, getTime } from '../utils/point-utils';
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${type} ${pointCity.name}</h3>
        ...
        ${pointOffers.map((offer) => offers.includes(offer.id) ? `
...
export default class PointView extends AbstractView {
  ...
  constructor({ point, onClick, onFavoriteClick, pointDestination, pointOffers, }) {
    super();
    this.#point = point;
